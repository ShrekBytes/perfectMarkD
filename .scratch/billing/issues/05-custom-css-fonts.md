...
- **Status flipped `ready-for-human` → `resolved`** (2026-09-23): the label means "requires human implementation", and the implementation above shipped and was verified in a real browser. Nothing here is still waiting on a human.
